...
public class EmployeeRepositoryImpl implements IEmployeeRepository{
    ...
    private static final String UPDATE = " UPDATE employee SET name = ?, gender = ? WHERE id = ? ";
    private static final String DELETE = " DELETE FROM employee WHERE id = ? ";
    private static final String FIND_BY_ID = " SELECT e.id, e.name, e.gender, lv.level FROM employee e join `level` lv on e.id_level = lv.id_level WHERE id = ? ";
    ...
    public Employee findById(int id) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                employee = new Employee(ids, name, gender, level);
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
